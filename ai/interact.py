...
from .train import SPECIAL_TOKENS, add_special_tokens_, build_input_from_segments
...
def chatbot(input_q, output_q):
    ...
    parser.add_argument(
        "--dataset_path",
        type=str,
        default="./data/personachat_self_original.json",
        help="Path or url of the dataset. If empty download from S3.",
    )
    parser.add_argument(
        "--dataset_cache",
        type=str,
        default="./data/dataset_cache_OpenAIGPTokenizer",
